...
describe('PaymentMonitorService (Dynamic Seller & Auto-Detection)', () => {
  let monitor: PaymentMonitorService;

  beforeEach(() => {
    // Reset in-memory invoices
    (memoryStorage as any).invoices.clear();

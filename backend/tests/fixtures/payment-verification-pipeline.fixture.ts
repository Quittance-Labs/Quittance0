...
export const OTHER_PUBLIC_KEY = 'GATTACKERAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA';
...
export function createTestTransaction(
  overrides: Partial<HorizonTransactionLike> = {}
): HorizonTransactionLike {
  return {
    memo: 'order-101',
    memo_type: 'text',
...
export function createTestOperation(
  overrides: Partial<HorizonOperationLike> = {}
): HorizonOperationLike {
  return {
    type: 'payment',

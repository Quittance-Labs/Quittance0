...
/**
 * Actions column: proof CTAs, QR, mobile fallback, Freighter pay, monitor, verify.
 * Preserves QR, manual, and Freighter payment paths from the previous monolithic route.
 */
export default function PayActionsSection({
  ...
  const email = () => {
    try {
      ...
      const message = err instanceof Error ? err.message : 'No recipient email on this invoice';
      toast.error(message);
    }
  };

...
export function getProofMailtoRecipient(invoice?: InvoiceMailtoInput | QuittanceProof | null): string;
export function buildInvoiceMailto(invoice: InvoiceMailtoInput, baseUrl?: string): string;
export function buildProofMailto(invoiceOrProof: InvoiceMailtoInput | QuittanceProof, baseUrl?: string, recipientOverride?: string): string;
export function openInvoiceMailto(invoice: InvoiceMailtoInput, baseUrl?: string): string;
export function openProofMailto(invoiceOrProof: InvoiceMailtoInput | QuittanceProof, baseUrl?: string, recipientOverride?: string): string;
